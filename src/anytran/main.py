...
"""
    ...
    voice_group.add_argument("--voice-backend", type=str, default="auto", choices=["piper", "gtts", "auto"], help="TTS backend (default: auto). Use 'piper' for Piper TTS or 'gtts' for Google TTS.")
